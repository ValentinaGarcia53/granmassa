...
<div class="container">
    ...
    <div class="row">
    <?php 
      $sentencia=$pdo->prepare("SELECT * FROM `extras`");
      $sentencia -> execute();
      $listaProductos=$sentencia->fetchAll(PDO::FETCH_ASSOC);
      //print_r($listaProductos);
    ?>
    <img class="img-fluid" src="assets/img/portfolio/menu/extras.jpg" alt="Extras">   
    <?php foreach($listaProductos as $producto){?>
        ...
        <div class="card bg-primary text-center mt-5 mx-2 rounded-0">
                ...
                <div class="card-body text-white">
                    ...
                    <h5 class="card-title text-">$<?php echo $producto['Precio'];?></h5>
                ...
                <button class="btn btn-primary text-light btn-outline-dark border-white rounded-0" type="submit" name="btnAccion" value="Agregar">Agregar al carrito</button>
                </form>
